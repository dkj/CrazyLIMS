...
BEGIN
  ...
  LOOP
    ...
    v_outputs := v_outputs || jsonb_build_array(jsonb_build_object('artefact_id', v_new, 'io_role', 'fragment_output'));
...
BEGIN
  ...
  LOOP
    ...
    v_outputs := v_outputs || jsonb_build_array(jsonb_build_object('artefact_id', v_new, 'io_role', 'library_output'));
