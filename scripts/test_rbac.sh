...
main() {
  ...
  request_postgrest "alpha-roberto-samples" "roberto.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Alpha%20Library%20L204%25" '' 'length > 0'
  request_postgrest "alpha-roberto-beta-denied" "roberto.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Beta%20Research%20Tube%25" '' 'length == 0'
  request_postgrest "alpha-roberto-labware" "roberto.jwt" "200" "GET" "/v_labware_inventory?select=barcode" '' '([.[] | .barcode] | (index("P202") != null and index("D203") != null and index("L204") != null))'
  request_postgrest "alpha-ross-ops-visibility" "ross.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Alpha%20Ops%25" '' 'length > 0'
  request_postgrest "alpha-ross-beta-denied" "ross.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Beta%25" '' 'length == 0'
  ...
  request_postgrest "beta-eric-samples" "eric.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Beta%20Research%20Tube%25" '' 'length > 0'
  request_postgrest "beta-eric-alpha-denied" "eric.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Alpha%20Library%20L204%25" '' 'length == 0'
  ...
  request_postgrest "alpha-roberto-projects" "roberto.jwt" "200" "GET" "/v_project_access_overview?select=project_code" '' '([.[] | .project_code] | index("alpha-study") != null)'
  request_postgrest "beta-eric-projects" "eric.jwt" "200" "GET" "/v_project_access_overview?select=project_code" '' '([.[] | .project_code] | (index("beta-study") != null and index("alpha-study") == null))'
  ...
  request_postgrest "ops-lucy-ops-visibility" "lucy.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Alpha%20Ops%25" '' 'length > 0'
  request_postgrest "ops-lucy-beta-denied" "lucy.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Beta%25" '' 'length == 0'
  request_postgrest "ops-fred-pool-visible" "fred.jwt" "200" "GET" "/v_sample_overview?select=name&name=eq.Alpha%20Pool%20Tube%20LT5" '' 'length == 1'
  request_postgrest "ops-fred-donor-denied" "fred.jwt" "200" "GET" "/v_sample_overview?select=name&name=ilike.Alpha%20Virtual%25" '' 'length == 0'
  ...
  request_postgrest "instrument-alpha-restricted" "instrument_alpha.jwt" "200" "GET" "/v_sample_overview?select=name" '' 'length == 0'
