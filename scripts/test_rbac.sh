...
main() {
  ...
  request_postgrest "researcher" "researcher.jwt" "200" "GET" "/v_sample_overview?select=name" '' '(. as $rows | ($rows | map(.name) | unique | sort) == (["DNA Intake Batch 001 - Donor 101","DNA Intake Batch 001 - Donor 102","DNA Intake Batch 001 - Donor 103","DNA Intake Batch 002 - Donor 201","DNA Intake Batch 002 - Donor 202","DNA Intake Batch 002 - Donor 203","GraphQL Smoke","Indexed Library Batch 001 - Donor 101","Indexed Library Batch 001 - Donor 102","Indexed Library Batch 001 - Donor 103","Indexed Library Batch 002 - Donor 201","Indexed Library Batch 002 - Donor 202","Indexed Library Batch 002 - Donor 203","Participant 001 Blood Draw","Participant 001 Blood Draw - Buffy Coat Fraction","Participant 001 Blood Draw - Plasma Fraction","Participant 001 Blood Draw - Plasma Fraction - LCMS Prep","PBMC Aliquot A","PBMC Batch 001","PBMC Batch 001 - Aliquot A","PBMC Batch 001 - Aliquot A - Cryovial 1","PBMC Batch 001 - Aliquot B","Sequencing Pool Run 001","Serum QC Control Sample"] | sort))'
  request_postgrest "researcher-bob" "researcher_bob.jwt" "200" "GET" "/v_sample_overview?select=name" '' 'map(.name) == ["Neutralizing Panel B"]'
  request_postgrest "researcher-labware" "researcher.jwt" "200" "GET" "/labware?select=barcode" '' 'map(.barcode) | sort == ["PLATE-0001","PLATE-DNA-0001","PLATE-DNA-0002","PLATE-LIB-0001","POOL-SEQ-0001","TUBE-0001"]'
