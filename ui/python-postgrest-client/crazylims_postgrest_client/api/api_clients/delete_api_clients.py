...
from ...models.delete_api_clients_prefer import DeleteApiClientsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteApiClientsPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteApiClientsPrefer]):
