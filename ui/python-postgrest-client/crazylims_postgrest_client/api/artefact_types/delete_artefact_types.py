...
from ...models.delete_artefact_types_prefer import DeleteArtefactTypesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteArtefactTypesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteArtefactTypesPrefer]):
