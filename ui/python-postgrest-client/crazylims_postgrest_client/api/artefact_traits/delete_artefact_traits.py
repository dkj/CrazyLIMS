...
from ...models.delete_artefact_traits_prefer import DeleteArtefactTraitsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteArtefactTraitsPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteArtefactTraitsPrefer]):
