...
from ...models.delete_user_roles_prefer import DeleteUserRolesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteUserRolesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteUserRolesPrefer]):
