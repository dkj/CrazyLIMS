...
from ...models.get_process_instances_prefer import GetProcessInstancesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, GetProcessInstancesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, GetProcessInstancesPrefer]):
