...
from ...models.get_container_slots_prefer import GetContainerSlotsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, GetContainerSlotsPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, GetContainerSlotsPrefer]):
