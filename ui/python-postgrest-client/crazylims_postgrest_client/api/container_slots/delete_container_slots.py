...
from ...models.delete_container_slots_prefer import DeleteContainerSlotsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteContainerSlotsPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteContainerSlotsPrefer]):
