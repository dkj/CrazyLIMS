...
from ...models.patch_notebook_entry_versions_prefer import PatchNotebookEntryVersionsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, PatchNotebookEntryVersionsPrefer] = UNSET,
    ...
    if isinstance(body, NotebookEntryVersions):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, PatchNotebookEntryVersionsPrefer]):
        body (NotebookEntryVersions): @omit
        body (NotebookEntryVersions): @omit
        body (NotebookEntryVersions): @omit
