...
from ...models.post_notebook_entries_prefer import PostNotebookEntriesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, PostNotebookEntriesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, PostNotebookEntriesPrefer]):
