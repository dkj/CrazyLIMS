...
from ...models.get_notebook_entries_prefer import GetNotebookEntriesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, GetNotebookEntriesPrefer] = UNSET,
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, list['NotebookEntries']]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = NotebookEntries.from_dict(response_200_item_data)
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, list['NotebookEntries']]]:
    return Response(
...
def sync_detailed(
    *,
...
) -> Response[Union[Any, list['NotebookEntries']]]:
    """ @omit
    ...
    Args:
        ...
        prefer (Union[Unset, GetNotebookEntriesPrefer]):
...
def sync(
    *,
...
) -> Optional[Union[Any, list['NotebookEntries']]]:
    """ @omit
    ...
    Returns:
        Union[Any, list['NotebookEntries']]
     """
