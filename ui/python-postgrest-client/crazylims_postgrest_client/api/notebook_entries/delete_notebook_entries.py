...
from ...models.delete_notebook_entries_prefer import DeleteNotebookEntriesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteNotebookEntriesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteNotebookEntriesPrefer]):
