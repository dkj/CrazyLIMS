...
from ...models.get_container_slot_definitions_prefer import GetContainerSlotDefinitionsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, GetContainerSlotDefinitionsPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, GetContainerSlotDefinitionsPrefer]):
