...
from ...models.get_process_scopes_prefer import GetProcessScopesPrefer
from ...models.process_scopes import ProcessScopes
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, GetProcessScopesPrefer] = UNSET,
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, list['ProcessScopes']]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = ProcessScopes.from_dict(response_200_item_data)
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, list['ProcessScopes']]]:
    return Response(
...
) -> Response[Union[Any, list['ProcessScopes']]]:
    """ 
    Args:
        ...
        prefer (Union[Unset, GetProcessScopesPrefer]):
...
) -> Optional[Union[Any, list['ProcessScopes']]]:
    """ 
    Args:
        process_instance_id (Union[Unset, str]):
        scope_id (Union[Unset, str]):
