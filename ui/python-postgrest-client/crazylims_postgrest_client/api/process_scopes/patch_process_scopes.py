...
from ...models.patch_process_scopes_prefer import PatchProcessScopesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, PatchProcessScopesPrefer] = UNSET,
    ...
    if isinstance(body, ProcessScopes):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, PatchProcessScopesPrefer]):
        body (ProcessScopes):
        body (ProcessScopes):
        body (ProcessScopes):
