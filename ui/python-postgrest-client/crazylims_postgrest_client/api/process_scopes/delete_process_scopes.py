...
from ...models.delete_process_scopes_prefer import DeleteProcessScopesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteProcessScopesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteProcessScopesPrefer]):
