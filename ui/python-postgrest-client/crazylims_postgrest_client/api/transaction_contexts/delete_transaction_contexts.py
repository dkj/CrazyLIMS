...
from ...models.delete_transaction_contexts_prefer import DeleteTransactionContextsPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, DeleteTransactionContextsPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, DeleteTransactionContextsPrefer]):
