...
from ...models.get_process_types_prefer import GetProcessTypesPrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, GetProcessTypesPrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, GetProcessTypesPrefer]):
