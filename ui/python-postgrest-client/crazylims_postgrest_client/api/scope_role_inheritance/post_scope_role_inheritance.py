...
from ...models.post_scope_role_inheritance_prefer import PostScopeRoleInheritancePrefer
...
def _get_kwargs(
    *,
    ...
    prefer: Union[Unset, PostScopeRoleInheritancePrefer] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        prefer (Union[Unset, PostScopeRoleInheritancePrefer]):
