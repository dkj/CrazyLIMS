...
T = TypeVar("T", bound="ArtefactScopes")



@_attrs_define
class ArtefactScopes:
    """ 
        Attributes:
            artefact_id (UUID): Note:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        artefact_id = UUID(d.pop("artefact_id"))
        ...
        artefact_scopes.additional_properties = d
        return artefact_scopes
