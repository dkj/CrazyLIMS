...
T = TypeVar("T", bound="PostRpcCanAccessArtefactJsonBody")



@_attrs_define
class PostRpcCanAccessArtefactJsonBody:
    """ 
        Attributes:
            p_artefact_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_rpc_can_access_artefact_json_body = cls(
            p_artefact_id=p_artefact_id,
            p_required_roles=p_required_roles,
        )


        post_rpc_can_access_artefact_json_body.additional_properties = d
        return post_rpc_can_access_artefact_json_body
